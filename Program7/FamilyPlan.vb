Public Class FamilyPlan
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If (isFormFilledOut()) Then
            Total = PHONEPRICES(PhoneIndex) * Integer.Parse(TextBox1.Text)
    ...
    Private Function isFormFilledOut() As Boolean
        ...
        If (TextBox1.Text.Length = 0) Then
            MessageBox.Show("Number of Phones should not be blank")
            Return False
        End If
        If (Integer.Parse(TextBox1.Text) < 0) Then
            MessageBox.Show("The number must be non-negative")
            Return False
        End If
